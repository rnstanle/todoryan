...
public class NoteBookAdapter extends ArrayAdapter<NoteBook>{
	...
	public NoteBookAdapter(Context context, int layoutResourceId) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		final NoteBook currentItem = getItem(position);
		final String old_title = currentItem.getTitle();
		...
		builder.setTitle("Do you want to delete this Notebook?");
		...
		textView.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Toast.makeText(getContext(), "Show notes for this book", Toast.LENGTH_SHORT).show();
			}
		});
